require(["../../../static/conf/config.js"], function() {
	require(["jquery", "sw"], function($, Swiper) {
		...
		let p = 1;
		let sort = "new";
		let k = window.location.search.split("=")[1].split("&")[0];
		$(function() {
			$.ajax({
				url: "http://localhost:8000/search",
				type: "get",
				dataType: "json",
				data : {k:k,sort:sort,p:p},
				success: function(d) {
					let html = "";
		...
		$(".search-btn").on("click", function() {
			...
			window.location = "index.html?k=" + searchData.k + "&sort=" + searchData.sort + "&p=" + searchData.p;
		});
	})
})
